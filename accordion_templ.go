...
func AlterClassName(id string) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_AlterClassName_95e1`,
		Function: `function __templ_AlterClassName_95e1(id){let element = document.getElementById(id)
	...
	if (element.checked) {
		...
		Call:       templ.SafeScript(`__templ_AlterClassName_95e1`, id),
		CallInline: templ.SafeScriptInline(`__templ_AlterClassName_95e1`, id),
	}
}
...
func Accordion(acc AccordionAttrs) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for i, item := range acc.Items {
			...
			var templ_7745c5c3_Var6 templ.ComponentScript = AlterClassName(formatName(acc.Name, i))
			...
			templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinStringErrs(formatName(acc.Name, 1))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `accordion.templ`, Line: 84, Col: 35}
			}
			...
			templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(formatName(acc.Name, i))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `accordion.templ`, Line: 85, Col: 33}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `accordion.templ`, Line: 91, Col: 17}
			}

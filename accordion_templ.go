...
func AlterClassName(id string) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_AlterClassName_b509`,
		Function: `function __templ_AlterClassName_b509(id){let element = document.getElementById(id)
	...
	if (element.checked) {
		...
		Call:       templ.SafeScript(`__templ_AlterClassName_b509`, id),
		CallInline: templ.SafeScriptInline(`__templ_AlterClassName_b509`, id),
	}
}
